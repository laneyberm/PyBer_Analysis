...
1. Assuming that ride share per mile is the same rate for all city types, we can find that drivers in rural cities make higher average fare per ride and per driver. But they have the lowest amount of total rides and lowest amount of total drivers. So, rural cities need more drivers to be available for the customers. We should enact additional marketing or monetary incentives to these areas focusing on hiring drivers to have available to the customers. This would increase revenue for the overall company because rural cities make higher average fares. 

2. Since the Average Fare per ride and per driver is higher for rural cities, we also assume that these underserved neighborhoods are more expensive to customers per ride but we want to lower these rates for these customers. By doing so, we may attract more customers to the company and grow the business. Before we start marketing to customers or giving them discount rates, we would need more information to the rideshare data, specifically conditions that effects the fare to be higher. I would recommend that we find data on how many miles the ride are and at what time of day. Because generalizing that we need to target customers in this area to have more affordable fares is nice, but we need to know what affects their fare to be so high. 

3. Across all city types, we see that the month of February have the highest total fare. I would recommend that to increase revenue a total area marketing campaign focused on the rideshare customer should be executed in the month leading up to February to increase visibility for the overall business. 
